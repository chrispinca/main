...
function ProductList() {
    ...
    useEffect(() => {
        const currentProducts = [
            ...
            { id: 5, name: "Crazy Couch", price: 12.99, image: "https://img.freepik.com/premium-photo/discover-beautiful-elegant-wood-furniture-stunning-furniture-images-included_629704-1400.jpg" },
